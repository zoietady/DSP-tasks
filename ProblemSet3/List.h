...
public:
    ...
    const T& operator[]( size_t aIndex ) const	                                // list indexer
    {
        ...
        {
            throw std::range_error( "Index out of bounds." );                   // 4(26)
        }
    }
